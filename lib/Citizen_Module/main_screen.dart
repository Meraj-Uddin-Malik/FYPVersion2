                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 10), // Space between search box and bell icon
                          GestureDetector(
                            onTap: () {
                            ...
                            child: Container(
                              ...
                              decoration: const BoxDecoration(
                                ...
                                color: Colors.white12, // Slight background for better visibility
                              ),
                              child: const Icon(
                                Icons.notifications,
                                color: Colors.white,
                          ...
                          const SizedBox(width: 10), // Space between bell icon and menu icon
                          GestureDetector(
                            onTap: () {
