...
import 'package:fyp_v2/Admin_Module/user_details_screen.dart';
...
void main() async {
  ...
  runApp(MaterialApp(home: UsersManagementScreen()));
}
...
class _UsersManagementScreenState extends State<UsersManagementScreen> {
  ...
  void fetchUsers({bool isLoadMore = false}) async {
    ...
    Query query = FirebaseFirestore.instance
        .collection('users')
        .where('role', isEqualTo: 'CITIZEN') // ✅ Fetch only Police
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => UserDetailScreen(user: user, userId: filteredUsers[index].id),
                                  ),
                                );
                              },
                            ),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) => Card(
          ...
          child: ListTile(
            ...
            title: Container(height: 10, width: 100, color: Colors.grey[400]),
            subtitle: Container(height: 10, width: 80, color: Colors.grey[300]),
          ),
        ),
      ),
    );
